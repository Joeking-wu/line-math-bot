        ...
        carousel_template = TemplateSendMessage(
            ...
            template=CarouselTemplate(
                columns=[
                    # 第一排 3 個遊戲
                    CarouselColumn(
                        thumbnail_image_url='https://via.placeholder.com/240x200.png?text=加法GAME',
                        title='加法GAME',
                        text='點擊開始加法遊戲',
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://via.placeholder.com/240x200.png?text=減法GAME',
                        title='減法GAME',
                        text='點擊開始減法遊戲',
                        actions=[URITemplateAction(
                            label='玩減法',
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://via.placeholder.com/240x200.png?text=寶可夢GAME',
                        title='寶可夢GAME',
                        text='點擊開始寶可夢遊戲',
                        actions=[URITemplateAction(
                            label='玩寶可夢',
                    ...
                    # 第二排 3 個遊戲
                    CarouselColumn(
                        thumbnail_image_url='https://via.placeholder.com/240x200.png?text=時鐘GAME',
                        title='時鐘GAME',
                        text='點擊開始時鐘遊戲',
                        actions=[URITemplateAction(
                            label='玩時鐘',
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://via.placeholder.com/240x200.png?text=九九乘法表GAME',
                        title='九九乘法表GAME',
                        text='點擊開始九九乘法表遊戲',
                        actions=[URITemplateAction(
                            label='玩九九乘法表',
                    ...
                    CarouselColumn(
                        thumbnail_image_url='https://via.placeholder.com/240x200.png?text=小朋友珠算入門',
                        title='小朋友珠算入門',
                        text='點擊開始珠算遊戲',
                        actions=[URITemplateAction(
                            label='小朋友珠算入門',
